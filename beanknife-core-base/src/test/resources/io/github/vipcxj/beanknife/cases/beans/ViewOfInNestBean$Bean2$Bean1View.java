...
public class ViewOfInNestBean$Bean2$Bean1View {
    ...
    public ViewOfInNestBean$Bean2$Bean1View(ViewOfInNestBean.Bean2.Bean1 source) {
        if (source == null) {
            throw new NullPointerException("The input source argument of the read constructor of class io.github.vipcxj.beanknife.cases.beans.ViewOfInNestBean$Bean2$Bean1View should not be null.");
        }
    }
    ...
    public static ViewOfInNestBean$Bean2$Bean1View read(ViewOfInNestBean.Bean2.Bean1 source) {
        ...
        return new ViewOfInNestBean$Bean2$Bean1View(source);
    }
