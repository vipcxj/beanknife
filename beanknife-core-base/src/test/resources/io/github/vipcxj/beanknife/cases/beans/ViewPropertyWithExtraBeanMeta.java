...
public class ViewPropertyWithExtraBeanMeta {
    public static final String a = "a";
    public static final String b = "b";
    public static final String c = "c";

    public static class Views {
        public static final String io_github_vipcxj_beanknife_cases_beans_ViewPropertyWithExtraBeanView = "io.github.vipcxj.beanknife.cases.beans.ViewPropertyWithExtraBeanView";
    }
}
